...
namespace DoAnLTWeb.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DoAnLTWebContext context)
        {
            _context = context;
        }
        ...
        {
            var doAnLTWebContext = _context.Product.Include(p => p.category);
            return View(await doAnLTWebContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DoAnLTWebContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
